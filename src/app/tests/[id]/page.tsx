...
function TestDetailInner() {
  ...
  return (
    <div className="p-4 sm:p-8 max-w-6xl mx-auto space-y-6">
      ...
      {/* MB-3 — plain-English narration. Shows for both brand and
          factory readers above the raw numeric panels so the
          summary frames the data. */}
      {test.aiNarration && (
        <div className="bg-cyan-50 border border-cyan-200 rounded-xl p-5 mb-4">
          ...
          <p className="text-[10px] text-slate-500 mt-2">
            ...
            {test.aiNarrationGeneratedAt
              ? ` · ${new Date(test.aiNarrationGeneratedAt).toLocaleDateString("en-US", {
                  month: "short",
                  day: "numeric",
                  year: "numeric",
                })}`
